''''
Description:
    The movement estimation for data at the T-juntion.
...
class TJunctionEstimatior(Estimator):
    ...
    def __init__(self, filename):
        super(TJunctionEstimatior, self).__init__(filename)
...
if __name__ == '__main__':
    estimator = TJunctionEstimatior('./extracted_data/normal_all_data.csv')
