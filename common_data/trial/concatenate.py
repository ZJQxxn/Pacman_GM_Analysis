...
with open("8000_trial_data_Omega-with_Q-simple.pkl", "rb") as file:
    data_1000 = pickle.load(file)
    print("8000 Trial Data Shape : ", data_1000.shape)

with open("7000_trial_data_Patamon-with_Q-simple.pkl", "rb") as file:
...
with open("all_trial_data-simple.pkl", "wb") as file:
