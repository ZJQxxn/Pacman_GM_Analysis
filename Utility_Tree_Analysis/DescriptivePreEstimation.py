...
def _individualEstimation(all_data, adjacent_data, locs_df, adjacent_path, reward_amount):
    ...
    for index in range(num_samples):
        ...
        # Suicide agent
        suicide_agent = ApproachingAgent(
            adjacent_data,
            adjacent_path,
            locs_df,
            reward_amount,
        ...
        planned_hunting_agent = EnergizerAgent(
            adjacent_data,
            adjacent_path,
            locs_df,
            reward_amount,
...
def preEstimation():
    ...
    filename_list = [
        ...
        "../common_data/trial/new_200_trial_data_Omega.pkl",
        "../common_data/trial/accidental_200_trial_data_Omega.pkl",
        # "../common_data/trial/test_planned_trial_data_Omega.pkl",
        # "../common_data/trial/test_suicide_trial_data_Omega.pkl",
        "../common_data/trial/suicide_200_trial_data_Omega.pkl",
        "../common_data/trial/global_200_trial_data_Omega.pkl",
    ...
    for filename in filename_list:
        ...
        with open("{}/{}-with_Q-descriptive.pkl".format(
